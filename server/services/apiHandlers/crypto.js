  ...
  try {
    ...
    if (coinsToFetch.length > 0) {
      ...
      try {
        ...
        // MEMORY OPTİMİZASYON: parallelLimit 20'den 3'e düşürüldü (memory spike önleme)
        const batchSize = 150 // Küçük batch'ler = daha az memory
        const parallelLimit = 3 // DÜŞÜRÜLDÜ: 20 paralel istek çok fazla memory tüketiyordu
        const batches = []
